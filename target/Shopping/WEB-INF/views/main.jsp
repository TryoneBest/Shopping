		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">儿童书籍 <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">学习资料</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">古代小说</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">哲学小说</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">新闻报刊</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">作业题集</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">影视资料</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>欢迎来到书城</h1>
					<p>书城是一个非常优秀的购物网站，你可以在这里买到物美价廉的书籍，虽然它只是练习用的项目，哈哈哈哈</p>
				</div>
